...
.controller('totalCtrl214142', function($scope, $ionicLoading) {
    // Map Settings //
      var cities = [
    {
        city : 'Location 1',
...
.controller('totalCtrl453454', function($scope, $ionicLoading, $compile) {
...
.controller('totalCtrlprueba', function($scope, $state, $cordovaGeolocation) {
